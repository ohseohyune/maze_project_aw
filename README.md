...
`maze_main.py` scales the joint trajectory to 4.0 seconds.
...
`maze_main.py` runs a headless MuJoCo check before opening the viewer.
`maze_main.py` also generates `reference/robotis_omy/scene_maze_planned.xml`
